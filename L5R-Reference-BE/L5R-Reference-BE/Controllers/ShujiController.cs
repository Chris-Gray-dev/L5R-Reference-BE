...
namespace L5R_Reference_BE.Controllers
{
    ...
    [ApiController]
    public class ShujiController : ControllerBase
    {
        private const TechniqueType _type = TechniqueType.Shuji;
        private readonly TechniqueService _techniqueService;
        public ShujiController(TechniqueService techniqueService)
        {
